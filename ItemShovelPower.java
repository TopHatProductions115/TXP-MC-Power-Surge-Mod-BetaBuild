...
public class ItemShovelPower extends ItemToolPower
{
    private static String textureName;

    public ItemShovelPower(int i, EnumToolPower enumtoolpower, String textureName)
    {
        super(i, 1, enumtoolpower, blocksEffectiveAgainst);  
