...
public class ItemHoeTXPPower extends Item
{
    private static String textureName;

    protected EnumToolTXPPower theToolTXPPower;

    public ItemHoeTXPPower(int par1, EnumToolTXPPower par2EnumToolTXPPower, String textureName)
    {
        super(par1);   
        this.maxStackSize = 1;
        this.theToolTXPPower = par2EnumToolTXPPower;
        this.setMaxDamage(par2EnumToolTXPPower.getMaxUses());
    ...
    {
        return this.theToolTXPPower.toString();
    }    
