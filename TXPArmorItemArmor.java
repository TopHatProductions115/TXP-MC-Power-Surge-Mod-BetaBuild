...
public class TXPArmorItemArmor extends ItemArmor
{
    ...
    private final TXPArmorArmorMaterial material;
 
    public TXPArmorItemArmor(int i, TXPArmorArmorMaterial enumarmormaterial, int j, int k, String textureName)
    {
