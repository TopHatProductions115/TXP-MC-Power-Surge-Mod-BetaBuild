...
public class ItemPickaxeTXPPower extends ItemToolTXPPower
{    
    ...
    protected ItemPickaxeTXPPower(int par1, EnumToolTXPPower par2EnumToolTXPPower, String textureName)
    {
        super(par1, 2, par2EnumToolTXPPower, blocksEffectiveAgainst);  
